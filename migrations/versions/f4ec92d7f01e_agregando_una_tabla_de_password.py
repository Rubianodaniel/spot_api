...
Revision ID: f4ec92d7f01e
Revises: 8092b9d591c1
Create Date: 2023-05-18 20:18:40.123995
...
revision = 'f4ec92d7f01e'
down_revision = '8092b9d591c1'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('camara_id', sa.VARCHAR(), nullable=False),
